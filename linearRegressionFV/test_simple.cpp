...
namespace FV {
    namespace params {
        using poly_t = nfl::poly_from_modulus<uint64_t, 1 << 13, 400>;
        template <typename T>
        ...
        gauss_t fg_prng_sk(4.0, 128, 1 << 30);
        gauss_t fg_prng_evk(4.0, 128, 1 << 30);
        gauss_t fg_prng_pk(4.0, 128, 1 << 30);
        gauss_t fg_prng_enc(4.0, 128, 1 << 30);
    }
}  // namespace FV::params
#include "FV.hpp"
