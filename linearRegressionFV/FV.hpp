...
namespace FV {
    namespace util {
        ...
        /*inline void lift(mpz_t &coefficients,
                         params::polyZ_p const &c);*/
...
namespace FV {
    ...
    public:
        ...
        /// Constructor
        /*evk_t(P const **values_in, size_t word_size) : word_size(word_size) {
            ...
            for (size_t i = 0; i < ell; ++i) {
                values[i][0] = values_in[i][0];
                values[i][1] = values_in[i][1];
        ...
        //main one used in our implementation
...
namespace FV {
    ...
    public:
        ...
        ciphertext_t(P &c01,P &c11,pk_t &pk_in) : c0(c01), c1(c11),pk(&pk_in) {
            /*if (ct.pk != nullptr) {
                pk = ct.pk;
            }*/
            isnull = false;
        ...
        ciphertext_t &operator*=(ciphertext_t const &ct) {
            ...
            //mpz_t *coefficients = new mpz_t[P::degree];
